...
INDICATOR_CATALOG: dict[str, IndicatorMeta] = {
    ...
    "roc": IndicatorMeta(
        ...
        description="Percentage price change over N periods. Positive = upward momentum. Signals on zero crossover.",
    ),
    "roc2": IndicatorMeta(
        name="roc2",
        human_name="Rate of Change 2nd Derivative (Acceleration)",
        category="momentum",
        required_inputs=["close"],
        default_params={"roc_length": 12, "deriv_length": 3},
        param_ranges={
            "roc_length": {"min": 2, "max": 30, "step": 1},
            "deriv_length": {"min": 1, "max": 10, "step": 1},
        },
        description="Change-in-ROC: measures momentum acceleration. Positive = momentum increasing (buy), negative = decelerating (sell). Signals on zero crossover.",
    ),
    "cci": IndicatorMeta(
        name="cci",
